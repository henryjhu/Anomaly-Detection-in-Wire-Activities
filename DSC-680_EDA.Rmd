...
AS_103_df$MONTH_TEXT <- factor(AS_103_df$MONTH_TEXT)
ggplot(AS_103_df) +
...
AS_202_df$MONTH_TEXT <- factor(AS_202_df$MONTH_TEXT)
ggplot(AS_202_df) +
geom_bar( aes(x = MONTH_TEXT, y = AVG_TRXN_AMT), stat = "identity", fill='#5DADE2', color="#000000") +
geom_line(aes(x = MONTH_TEXT, y = AVG_TRXN_AMT), size = 1.5, color="green", group = 1) +
...
EU_103_df$MONTH_TEXT <- factor(EU_103_df$MONTH_TEXT)
ggplot(EU_103_df) +
geom_bar( aes(x = MONTH_TEXT, y = AVG_TRXN_AMT), stat = "identity", fill='#5DADE2', color="#000000") +
geom_line(aes(x = MONTH_TEXT, y = AVG_TRXN_AMT), size = 1.5, color="green", group = 1) +
...
EU_202_df$MONTH_TEXT <- factor(EU_202_df$MONTH_TEXT)
ggplot(EU_202_df) +
geom_bar( aes(x = MONTH_TEXT, y = AVG_TRXN_AMT), stat = "identity", fill='#5DADE2', color="#000000") +
geom_line(aes(x = MONTH_TEXT, y = AVG_TRXN_AMT), size = 1.5, color="green", group = 1) +
...
NN_103_df$MONTH_TEXT <- as.factor(NN_103_df$MONTH_TEXT)
ggplot(NN_103_df) +
geom_bar( aes(x = MONTH_TEXT, y = AVG_TRXN_AMT), stat = "identity", fill='#5DADE2', color="#000000") +
geom_line(aes(x = MONTH_TEXT, y = AVG_TRXN_AMT), size = 1.5, color="green", group = 1) +
...
NN_202_df$MONTH_TEXT <- factor(NN_202_df$MONTH_TEXT)
ggplot(NN_202_df) +
geom_bar( aes(x = MONTH_TEXT, y = AVG_TRXN_AMT), stat = "identity", fill='#5DADE2', color="#000000") +
geom_line(aes(x = MONTH_TEXT, y = AVG_TRXN_AMT), size = 1.5, color="green", group = 1) +
...
options(repr.plot.width = 15, repr.plot.height = 10)
ggplot(data = input_data_eda, aes(x=TRANSACTION_AMOUNT)) + geom_histogram(alpha=0.6, fill='#5DADE2', color="#000000") + xlim(10000,18000) + ylim(0,15) +
